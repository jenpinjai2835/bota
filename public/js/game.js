...
const CHARACTERS = [
  {
    ...
    sprite: {
      ...
      baseFacing: -1,
      sheets: {
        idle: { src: '/assets/sprites/dragonfist-idle.png', cols: 8, rows: 1, frames: 8, fps: 6, scale: 2.7, baseFacing: 1, footY: 0.94, visualHeight: 0.82, plateWidth: 1.08, frameAspect: true },
