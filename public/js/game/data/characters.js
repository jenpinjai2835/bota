...
const CHARACTERS = [
  {
    ...
    sprite: {
      ...
      sheets: {
        ...
        run: { src: '/assets/sprites/dragonfist-run-v2.png', cols: 4, rows: 4, frames: 16, fps: 18, scale: 3.8, baseFacing: -1, footY: 0.77, visualHeight: 0.72, plateWidth: 1.08, frameAspect: true },
