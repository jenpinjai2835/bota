...
const CHARACTERS = [
  {
    ...
    sprite: {
      ...
      sheets: {
        ...
        attack: { src: '/assets/sprites/dragonfist-attack-v2.png', cols: 5, rows: 5, frames: 25, fps: 28, scale: 3.78, baseFacing: 1, footY: 0.8, visualHeight: 0.74, plateWidth: 1.08, frameAspect: true },
        attackKick: { src: '/assets/sprites/dragonfist-kick-right.png', cols: 5, rows: 5, frames: 25, fps: 28, scale: 3.78, baseFacing: 1, footY: 0.81, visualHeight: 0.78, plateWidth: 1.08, frameAspect: true },
      },
    },
